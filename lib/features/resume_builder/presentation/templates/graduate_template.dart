...
/// Fresh Graduate Template - Education-focused layout
class GraduateTemplate extends StatelessWidget {
  const GraduateTemplate({super.key, required this.resume});
      ...
      child: Column(
        ...
        children: [
          ...
          if (resume.experience.isNotEmpty) ...[
            SectionTitle(title: 'Experience', underline: true),
            const SizedBox(height: 12),
            ExperienceSection(experience: resume.experience),
            const SizedBox(height: 24),
          ],
          if (resume.projects.isNotEmpty) ...[
            SectionTitle(title: 'Academic Projects', underline: true),
            const SizedBox(height: 12),
          ...
          if (resume.certifications.isNotEmpty) ...[
            SectionTitle(title: 'Certifications & Awards', underline: true),
            const SizedBox(height: 12),
