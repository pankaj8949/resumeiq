...
/// Product Manager Template - Impact and metrics-focused
class ProductManagerTemplate extends StatelessWidget {
  const ProductManagerTemplate({super.key, required this.resume});
      ...
      child: Column(
        ...
        children: [
          ...
          if (resume.experience.isNotEmpty) ...[
            SectionTitle(title: 'Product Experience', underline: true),
            const SizedBox(height: 12),
            ExperienceSection(experience: resume.experience),
            const SizedBox(height: 24),
          ],
          if (resume.projects.isNotEmpty) ...[
            SectionTitle(title: 'Key Projects & Initiatives', underline: true),
            const SizedBox(height: 12),
            ProjectsSection(projects: resume.projects),
            const SizedBox(height: 24),
          ],
          if (resume.skills.isNotEmpty) ...[
            SectionTitle(title: 'Core Skills', underline: true),
            const SizedBox(height: 12),
            SkillsSection(
