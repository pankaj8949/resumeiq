...
class UserModel extends UserEntity {
  const UserModel({
    ...
    super.phone,
    super.location,
    super.currentDesignation,
    super.linkedInUrl,
    super.portfolioUrl,
    super.githubUrl,
    super.summary,
    super.profileCompletionDone,
    super.education,
    super.experience,
    super.skills,
    super.projects,
  ...
  factory UserModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return UserModel(
      ...
      currentDesignation: data['currentDesignation'] as String?,
      linkedInUrl: data['linkedInUrl'] as String?,
      portfolioUrl: data['portfolioUrl'] as String?,
      githubUrl: data['githubUrl'] as String?,
      summary: data['summary'] as String?,
      profileCompletionDone: (data['profileCompletionDone'] as bool?) ?? false,
  ...
  factory UserModel.fromEntity(UserEntity entity) {
    return UserModel(
      ...
      profileCompletionDone: entity.profileCompletionDone,
